...
<head>
    ...
    <title>AutoLoc - Gestion des Parcs</title>
...
<div class="container mt-5 animate-fade">
        ...
        <div class="container position-relative">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <p class="mb-0 mt-2">Gérez vos parcs automobiles en toute simplicité</p>
                </div>
                <div class="col-lg-6 text-lg-end mt-3 mt-lg-0">
                    <a href="/parc/add" class="btn btn-light">
                        <i class="fas fa-plus me-2"></i>Nouveau Parc
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="alert alert-success d-flex align-items-center" role="alert">
        ...
        <div>Le parc a été ajouté avec succès!</div>
    </div>
    <% } %>
    <% if (request.getAttribute("updated") != null) { %>
    <div class="alert alert-success d-flex align-items-center" role="alert">
        <i class="fas fa-check-circle me-2"></i>
        <div>Le parc a été mis à jour avec succès!</div>
    </div>
    <% } %>
    <% if (request.getAttribute("deleted") != null) { %>
    <div class="alert alert-success d-flex align-items-center" role="alert">
        <i class="fas fa-check-circle me-2"></i>
        <div>Le parc a été supprimé avec succès!</div>
    </div>
    <% } %>
        ...
        <div class="col-md-4">
            <div class="stats-card text-center">
                ...
                <h3 class="h4">
                    ...
                    <%= parcs != null ? parcs.size() : 0 %>
                </h3>
                <p class="mb-0">Parcs Total</p>
            </div>
        </div>
        <div class="col-md-4">
            <div class="stats-card text-center">
    ...
    <div class="card">
        <div class="card-body">
            <table id="parcsTable" class="table table-hover">
                <thead>
                <tr>
                    <th>ID</th>
                    <th>Libellé</th>
                ...
                <% if (parcs != null) {
                    for (Parc parc : parcs) { %>
                <tr>
                    <td><%= parc.getNum_parc() %></td>
                    <td><%= parc.getLibelle() %></td>
                    <td><%= parc.getLocalisation() %></td>
                    <td><%= parc.getCapacite() %> véhicules</td>
                    <td class="action-buttons">
                        <a href="/parc/updating?id=<%= parc.getNum_parc() %>"
                           class="btn btn-warning btn-sm me-2" title="Modifier">
                            <i class="fas fa-edit"></i>
                        </a>
                        <button onclick="confirmDelete(<%= parc.getNum_parc() %>)"
...
<script>
    ...
    function confirmDelete(id) {
        if (confirm('Êtes-vous sûr de vouloir supprimer ce parc ?')) {
            window.location.href = '/parc/delete?id=' + id;
        }
    }
