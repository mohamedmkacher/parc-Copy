...
<head>
    ...
    <title>AutoLoc - Ajouter une Voiture</title>
        ...
        <div class="col-lg-8">
                ...
                <div class="container position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="mb-0 mt-2">Enregistrez un nouveau véhicule dans la flotte</p>
                        </div>
            ...
            <div class="form-card">
                <div class="card-body p-4">
                    <form action="/voiture/save" method="post" class="needs-validation" novalidate>
                        ...
                        <div class="form-section">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        ...
                                        <input type="text" class="form-control" id="matricule" name="matricule"
                                               placeholder="Matricule" required pattern="[A-Z0-9-]+">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="number" step="0.01" class="form-control" id="prixJour" name="prixJour" placeholder="Prix par jour" required min="0">
...
<script>
    $(document).ready(function() {
        ...
        matriculeInput.addEventListener('input', function(e) {
            const isValid = /^[A-Z0-9-]+$/.test(e.target.value);
            e.target.setCustomValidity(isValid ? '' : 'Le matricule doit contenir uniquement des lettres majuscules, des chiffres et des tirets');
        });
