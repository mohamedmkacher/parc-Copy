        ...
        <div class="col-lg-8">
                ...
                <div class="container position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="mb-0 mt-2">Modifier les informations du parc</p>
                        </div>
            ...
            <div class="form-card">
                <div class="card-body p-4">
                    ...
                    <form action="/parc/update" method="post" class="needs-validation" novalidate>
                        <input type="hidden" name="id" value="<%= parc.getNum_parc() %>">

                        <div class="form-floating position-relative">

                            <input type="text" class="form-control" id="libelle" name="libelle"
                                   value="<%= parc.getLibelle() %>" required>
                            <label for="libelle"> <i class="fas fa-tag form-icon"></i>
                                Libellé du parc</label>
                        ...
                        <div class="form-floating position-relative">
                            ...
                            <input type="text" class="form-control" id="localisation" name="localisation"
                                   value="<%= parc.getLocalisation() %>" required>
                        ...
                        <div class="form-floating position-relative">
                            ...
                            <input type="number" class="form-control" id="capacite" name="capacite"
                                   value="<%= parc.getCapacite() %>" min="1" required>
